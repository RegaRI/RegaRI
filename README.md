...
I'm a Computer Science student exploring the space where data, models, and real applications meet. My coursework and side projects span **Machine Learning**, **Data Mining**, **Cryptography**, and **Image Processing** — and I enjoy turning that theory into things people can actually use: chatbots, classifiers, forecasting models, and web or mobile apps.

```
const rega = {
    role: "Informatics Student",
    based_in: "Yogyakarta, Indonesia",
    focus: ["Machine Learning", "NLP / NLU", "Web & Mobile Dev"],
    currently: "Fine-tuning IndoBERT for intent classification",
    interests: "Practical, locally-run AI (on-device LLMs)"
};
```
