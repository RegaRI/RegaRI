<h1 align="center">Hi, I'm Rega 👋</h1>
...
<p align="center">
  <a href="https://github.com/RegaRI">
    <img src="https://komarev.com/ghpvc/?username=RegaRI&label=Profile%20Views&color=2E9EF7&style=flat" alt="Profile Views" />
  </a>
</p>
...
- 🎓 University student, currently exploring **Machine Learning**, **Data Mining**, **Cryptography**, and **Image Processing**
- 💻 Building projects across **mobile (Flutter)** and **web (PHP)** development
- 🤖 Currently deep-diving into **NLP & NLU** — from classic SVM/TF-IDF pipelines to fine-tuning **IndoBERT**
- 🔍 Interested in practical AI applications: chatbots, classification, and predictive models
- 🎧 When not coding, tinkering with budget-friendly IEMs and audio gear
...
**Tools:** Google Colab · Jupyter Notebook · Ollama (local LLM)
...
<table>
  <tr>
    <td width="50%">
      <h4>📝 CihuyNotes</h4>
      Note-taking web app built with PHP & MongoDB Atlas, complete with Google OAuth login.
      <br><br>
      <code>PHP</code> <code>MongoDB</code> <code>OAuth</code>
    </td>
    <td width="50%">
      <h4>🖐️ Gesture MP3 Player</h4>
      A fun side project — control music playback using hand gestures via computer vision.
      <br><br>
      <code>OpenCV</code> <code>MediaPipe</code> <code>Pygame</code>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <h4>👔 Sewa Jas Jogja Chatbot</h4>
      Local AI chatbot for a suit/shoe rental business — powered by Ollama + Qwen running fully on-device, with multi-turn conversation and streaming responses.
      <br><br>
      <code>Flask</code> <code>Ollama</code> <code>Qwen</code>
    </td>
    <td width="50%">
      <h4>🎯 Intent Classifier (NLU Pipeline)</h4>
      Intent & entity extraction pipeline for chatbot routing — evolving from SVM + TF-IDF to a fine-tuned IndoBERT model.
      <br><br>
      <code>IndoBERT</code> <code>SVM</code> <code>NLP</code>
    </td>
  </tr>
</table>
